...
(use-package vertico
  ...
  (setq vertico-count 15
        vertico-resize nil)
  (vertico-mode 1))
(defun my/vertico-sort-alpha-directories-first (candidates)
  "Sort CANDIDATES alphabetically, directories first."
  (sort candidates
        (lambda (a b)
...
(setq vertico-sort-function #'my/vertico-sort-alpha-directories-first)
...
(use-package orderless
  ...
  (setq completion-styles '(orderless basic)
        ...
        orderless-style-dispatchers '(seforim-orderless-hebrew-dispatcher)
               completion-category-overrides '((file (styles partial-completion) (cycle t) (sort directory-first)))))
